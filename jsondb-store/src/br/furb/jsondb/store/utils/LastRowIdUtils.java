...
public class LastRowIdUtils {
	...
	public static void saveLastRowId(File tableDir, LastRowId lastRowId) throws StoreException {
		try {
			JsonUtils.write(lastRowId, LastRowId.class, new File(tableDir, LAST_ROW_ID_FILE_NAME));
		} catch (IOException e) {
			throw new StoreException(e);
		}
	}

	public static void createLastRowId(File tableDir, LastRowId lastRowId) throws StoreException {
		try {
