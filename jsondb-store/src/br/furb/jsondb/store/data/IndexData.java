...
//
//		index = JsonUtils.parseJsonToObject(new StringReader(writer.toString()), IndexData.class);
//
//		for (Entry<MultiKey<? extends String>, List<Integer>> entry : index.mapEntries.entrySet()) {
